...
export default function VideoTab({ shots }) {
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 space-y-2">
                  ...
                  {selectedShots.map((s) => (
                    <div
                      ...
                      className="grid grid-cols-2 gap-x-3 gap-y-0.5 text-xs py-2 border-b border-gray-800 last:border-0 cursor-pointer hover:bg-gray-800 rounded px-2 -mx-2 transition-colors"
                    >
